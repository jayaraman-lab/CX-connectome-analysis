...
The default distance is in pixels with 8x8x8 nm/pixel resolution, so i convert by pixels*8(nm/pixel)/1000(nm/um).
...
cmapName = "colorMap_ExR_and_AOTU46.csv"
...
```{r}
regiondata = left_join(dataFilt,  [c("Type","regions","hex")], by = c("simpleType" = "Type"))
synprojSlice = ggplot() + 
