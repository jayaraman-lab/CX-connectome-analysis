...
PFL_toDNs_Half <- as_tbl_graph(induced_subgraph(CX_outGraphBi,c("PFL2_L","PFL2_R",
                                               ...
                                               "MBON27_L"))) %N>% mutate(x=case_when(
                                                  ...
                                                  type %in% c("CRE015_R","DNb01_2_R","PS077_R") ~ 0.8,
                                                  type == "LAL018_R" ~ 1,
                                                  type %in% c("DNa02_R") ~ 1.1,
                                                  type == "LAL014_R" ~ 1.4,
                                                  type == "LAL046_R" ~ 1.2,
                                                  type == "LAL010_R" ~ 1.6,
                                                  type == "LAL013_R" ~ 1.7,
                                                  type == "DNa04_R" ~ 0.93,
                                                  type == "DNa03_R" ~ 1.3,
                                                  type %in% c("DN?_5813078378","PS013_R","PS211_R","ExR8_R") ~ 0.6
                                                  ),
                                                  y=case_when(
...
PFL2DNsHalfPlot <- ggraph(PFL_toDNs_Half,layout="manual",x=x,y=y) + geom_vline(xintercept = 2,lty=2,color="grey50")+ geom_edge_fan(aes(color=customSupertype.from,width=weightRelative),end_cap = circle(3, "mm"),linejoin = "mitre",linemitre=3,
                   arrow =arrow(length = unit(1, 'mm'),type = "closed")) + geom_node_point(aes(color=customSupertype),size=4)+geom_node_text(aes(label=type),size = 6*mm2pt)+theme_paper_map()+scale_color_manual(values=c(customGraphPalette,customSupertypePalette))+ scale_edge_color_manual(values=c(customGraphPalette,customSupertypePalette)) + scale_edge_width(range=c(0.2,3),limits=c(0.001,NA),name="Relative weight") + guides(color="none",edge_color="none") 
...
```
```{r}
displayAnatomies(list("Source"=1652832941,
...
pathsToDNp32Plot <- ggraph(pathsToDNp32,layout="sugiyama") + geom_edge_fan(aes(color=supertype2.from,width=weightRelative),end_cap = circle(3, "mm"),linejoin = "mitre",linemitre=3,
                   arrow =arrow(length = unit(1, 'mm'),type = "closed")) + geom_node_point(aes(color=supertype2),size=4)+geom_node_text(aes(label=type),size = 6*mm2pt)+theme_paper_map()+scale_color_manual(values=c(customGraphPalette,"PFL"=supertype3Palette[["FB Columnar"]],"FR"=supertype3Palette[["FB Output"]]))+ scale_edge_color_manual(values=c(customGraphPalette,"PFL"=supertype3Palette[["FB Columnar"]],"FR"=supertype3Palette[["FB Output"]])) + scale_edge_width(range=c(0.2,3),limits=c(0.001,NA),name="Relative weight") + guides(color="none",edge_color="none") + theme(legend.position=c(0.6,0.5))
pathsToDNp32Plot
```
...
pathsToMDNPlot <- ggraph(pathsToMDNManual_left,layout="sugiyama") + geom_edge_fan(aes(color=supertype2.from,width=weightRelative),end_cap = circle(3, "mm"),linejoin = "mitre",linemitre=3,
                   arrow =arrow(length = unit(1, 'mm'),type = "closed")) + geom_node_point(aes(color=supertype2),size=4)+geom_node_text(aes(label=type),size = 6*mm2pt)+theme_paper_map()+scale_color_manual(values=c(customGraphPalette,"PFL"=supertype3Palette[["FB Columnar"]],"FR"=supertype3Palette[["FB Output"]]))+ scale_edge_color_manual(values=c(customGraphPalette,"PFL"=supertype3Palette[["FB Columnar"]],"FR"=supertype3Palette[["FB Output"]])) + scale_edge_width(range=c(0.2,3),limits=c(0.001,NA),name="Relative weight") + guides(color="none",edge_color="none") + scale_x_continuous(trans="reverse")
pathsToMDNPlot
```
```{r}
...
MDNsPlot <- ggraph(pathsToMDNManual,layout="manual",x=x,y=y) + geom_vline(xintercept = 1,lty=2,color="grey50")+ geom_edge_fan(aes(color=customSupertype.from,width=weightRelative),end_cap = circle(3, "mm"),linejoin = "mitre",linemitre=3,
                   arrow =arrow(length = unit(1, 'mm'),type = "closed")) + geom_node_point(aes(color=customSupertype),size=4)+geom_node_text(aes(label=type),size = 6*mm2pt,nudge_y = 0.1)+theme_paper_map()+scale_color_manual(values=c(customGraphPalette,customSupertypePalette))+ scale_edge_color_manual(values=c(customGraphPalette,customSupertypePalette)) + scale_edge_width(range=c(0.2,3),limits=c(0.001,NA),name="Relative weight") + guides(color="none",edge_color="none") + theme(legend.position=c(0.85,0.9))
