...
outputsFolder <- "~/Dropbox (HHMI)/FIBSEM CX Paper Jan 2020/Figures/NewOutputs/figure10-DNs/"
```
...
```
```{r}
save_plot(paste0(outputsFolder,"DNWeights.svg"),moreDNsPlot,base_width = 7,base_height=4.5)
```
