...
fig8SI1 <-PFL32LC33Mat + PFLLCOutMat + guide_area()+ plot_layout(design=layout,guides = "collect") + plot_annotation(title="Ouputs figure 8 SI1: PFL3 and LC33 convergences",theme=theme(title=element_text(size=12,face="bold")),tag_levels = "A")
```
...
fig8SI2 <- PFLRbToLTMCPlot + MB20LT85Anat + MC62Anat + plot_layout(design=layout)+plot_annotation(title= "Outputs figure 8 SI2: PFRb to Visual PNs",tag_levels = "A",theme=theme(title=element_text(size=12,face="bold"))) 
```
