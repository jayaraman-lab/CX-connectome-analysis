...
outputFig1 <- (outputsInnervation_R + theme(strip.text.x=element_text(angle=90)))+
   allOutViews + 
   countsSummary + plot_layout(design = layout)+plot_annotation(tag_levels = "A",title = "Figure 1 - Outputs: CX neurons downstream synapses outside the CX") & theme(plot.tag.position = c(-0.05, 1.1))
