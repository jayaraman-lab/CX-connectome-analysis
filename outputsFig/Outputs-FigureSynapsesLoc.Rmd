...
```{r}
displayAnatomies(synapses=filter(CXTargetsSyn,customContributor %in% c("PFL1","PFL2","PFL3")),
...
### Synapses of their main targets
```{r}
displayAnatomies(synapses=filter(CXTargetsSyn,
