...
outputsFolder <- "~/Dropbox (HHMI)/FIBSEM CX Paper Jan 2020/Figures/NewOutputs/figure10-firstSteps/"
```
...
### First order partners - homogeneity?
```{r}
ExR8Graph <- plotSubgraph(c("ExR8_R","ExR7_R"),graph=CX_outGraphRed,layout="stress") + coord_cartesian(clip="off")
ExR8Graph
```
## ExR2-6
