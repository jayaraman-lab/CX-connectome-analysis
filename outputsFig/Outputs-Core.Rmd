...
save(mainTargets,mainCXTargets,mainFFTargets,mainFFConns,allMainConns,mainFFTargetsNeurons,file="mainTargetsAndConns.Rdata")
```
...
Finally we save those objects for reuse:
```{r}
