...
```{r}
myTypeList = c("ER3a_a","ER3a_b","ER3a_c","ER3a_d","ER1_a","ER1_b")
...
for(st in c(0,2,3)){
  ...
  ggsave(paste("inputAndOutputComposition_",saveName,"_supertype",st,'_nonNorm.pdf', sep=''),plot = bar, device='pdf', path = "../neuprintR_analysis_plots/",
      scale = 1, width=15, height=10, units ="cm", dpi = 600, limitsize = TRUE)
}
