...
```{r}
APN_to_ER1_t2tpath = get_type2typePath(APN2and3, ER1b, by.roi = FALSE, n_steps = seq(5))
```
```{r}
APN_to_ER1or3_t2tpath = get_type2typePath(APN2and3, ER1and3, by.roi = FALSE, n_steps = seq(5))
```
