...
pdf("C:\\Users\\turnerevansd\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\FB\\AllFBClustering.pdf", width = 10, height = 10)
print(grid.arrange(pFB_Post,pFB_Pre,ncol=1))
dev.off()
```
