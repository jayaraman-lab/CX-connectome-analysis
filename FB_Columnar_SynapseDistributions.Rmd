...
PFX_Distribution=Get_SynLayerDistribution(All_PFX, 50, PFX_Dir_Dist) # 50 is good here
...
D0_Distribution=Get_SynLayerDistribution(All_D0, 50, D0_Dir_Dist) # 30 is good here
...
PFX_NeuronsOfTypePerLayer = subset(PFX_NeuronsOfTypePerLayer, PercentInLayer==100)
...
PFX_GlomToColumn_All=PFX_Distribution_Columns %>% group_by(bodyid, type, PBglom, FBcol) %>% summarise(Num_layers = n())
PFX_GlomToColumn_All=PFX_GlomToColumn_All %>% group_by(type, PBglom, FBcol) %>% summarise(Num_Neurons = n())
