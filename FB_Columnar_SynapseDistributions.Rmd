...
All_FX_PFX=rbind(All_Fx,All_PFX)
...
PFX_FB_Outputs=merge(PFX_FB_Outputs, Glom_And_Col_From, by="from", all.x=TRUE)
PFX_FB_Outputs=merge(PFX_FB_Outputs, Glom_And_Col_To, by="to", all.x=TRUE)
PFX_FB_Inputs=merge(PFX_FB_Inputs, Glom_And_Col_From, by="from", all.x=TRUE)
