...
This notebook shows how to generate the connectivity graph in **Figure 25 B** as well as connectivity matrices in **Figure 26 D**. It also will generate a type-to-type connectivity  matrix that shows all connections (i.e. no cutoff weight as used on the graphs).
...
arrowSize = 0# 0.4 # set to 0 if you prefer styling arrows in e.g. adobe illustrator
