---
title: "Analysis of inputs to the noduli (NO): connectivity graphs"
output:
  html_document:
    df_print: paged
  pdf_document: default
---
#Analysis of inputs to the NO: Connectivity graphs and corresponding connectivity matrices
This notebook shows how to generate the connectivity graph in **Figure 25 B** as well as the connectivity matrix in **Figure 26 D**. It also will generate a type-to-type connectivity  matrix that shows all connections (i.e. no cutoff weight as used on the graph).
