...
* useCustomPreSelection: FALSE vs. TRUE
* useCustomPostSelection TRUE  vs. TRUE
```{r}
ROI = "BU" #AOTU #name for reference
slctROI ="BU(R)" #AOTU(R) #name as in neuprint
...
Adjust settings for Figure 6 (AOTU) or 8 (BU)
* postNeuron: c("TuBu","TuTuB","AOTU046")  vs. c("ExR","AOTU046","TuBu",paste0("ER",seq(6)))
* postName:   "TuBu, TuTu and  AOTU46"     vs  "TuBu, ER and contralateral neurons"
```{r}
# POST
if(useCustomPostSelection){
  postNeuron = c("ExR","AOTU046","TuBu",paste0("ER",seq(6))) 
  postNeuron = paste0(postNeuron,".*")
  postName = "TuBu, ER and contralateral neurons"
...
###  Draw graph
cutoff:  0.01 for AOTU and 0.05 for BU
```{r, warning=FALSE} 
require(igraph)
...
arrowSize = 0#0.5 # set to 0 if you prefer styling arrows in e.g. adobe illustrator
