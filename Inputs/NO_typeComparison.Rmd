...
***Figure 26 C***
For Figure 26 C top, select myROIs ="NO(R)" and myROIsName = "NOr", for Figure 26 C bottom, select myROIs ="PB" and myROIsName = "PB".

For Figure 27 C (clustering of LNO neurons), select myROIs = unique(myTypes_filt$roi)[unique(myTypes_filt$roi)!="NO"] and myROIsName = "allButNO"
```{r}
myROIs = unique(myTypes_filt$roi)[unique(myTypes_filt$roi)!="NO"] #"NO(R)" # "PB"
myROIsName = "allButNO" #"NOr" #"PB"
...
Reordered connectivity matrices as shown in **Figure 26 figure supplement 1B,C**. 
```{r}
...
myROIs_in = unique(myInputTypes_bag$inputs$roi)[myInputTypes_bag$inputs$roi!="NO"]  #unique(myInputTypes_bag$inputs$roi)  
...
hcl=hclust(conmat_cd)
cut2 = 0.9#cutTH# 0.995 used for LNO inputs, 0.8 used otherwise
