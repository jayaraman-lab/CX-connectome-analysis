...
inOutContributionDataPrep <- function(myTypes_in_filt, myTypes_out_filt,  supertypeLevel){
  ...
  if(supertypeLevel == 0){
    ...
    inData = inData %>% mutate(partner=supertype(databaseType.from,supertypeLevel))
    outData = outData %>% mutate(partner=supertype(databaseType.to,supertypeLevel))
  }
