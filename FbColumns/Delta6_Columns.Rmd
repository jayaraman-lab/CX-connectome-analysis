...
for (ttt in 1:length(PbFb_Types)){
  ...
  NodeColors=color(c("black","#FFF688", "#FFA010", "#FF3610", "#FBB5DE", "#7D24E7", "#5C89C7", "#C7FFEF", "#81FB35", "#FFF688"))
  ...
  P1=ggraph(graph,layout="manual",x=NODES$x,y=NODES$y) +
    ...
    scale_edge_color_manual(values=ColumnColors) +
    scale_edge_width(range = c(0.75,0.9))
    
  ggsave(paste(FigDirOffset, "ColumnLocs_", PbFb_Types[ttt], "_", as.character(CurrentLayer), ".png", sep=""),
         plot = P1, device='png', scale = 1, width = 10, height = 8, units ="in", dpi = 300, limitsize = TRUE)
