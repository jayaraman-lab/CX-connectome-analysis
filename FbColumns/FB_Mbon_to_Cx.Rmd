...
# Get just the L/R pair with max weight.Can't jut average L/R pairs because relative weight needs to 
# first be summed over all postsynaptic neurons, but without looking at the anatomy in detail (especially for
# the indirect analsysis later, which involves many more neurons), its hard to know which fibers may be cut, 
# which neurons have fibers that cross hemispheres, etc. 
