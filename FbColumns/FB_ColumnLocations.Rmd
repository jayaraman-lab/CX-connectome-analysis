...
FigDirPNG=paste(PlotDir,"/FIG_ColPos_PNG/",sep='')
FigDirPDF=paste(PlotDir,"/FIG_ColPos_PDF/",sep='')
...
PLOT=TRUE    # Whether to plot every neuron's synaptic point clouder and kmean groups
