---
title: "Notebook getting FB synapses, performing PCA, and saving the data. C"
output:
  html_document:
    df_print: paged
---
...
### Get neurons in the ROI and exclude neurons that aren't FB columnar types
```{r}
...
ExcludedTypes=unique(NamedBodies$type[!Logica])
...
# Add pre and post body names to FBC_SynsAll (to get PB columns later)
