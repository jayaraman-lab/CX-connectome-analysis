...
SW_KnownDownstream=subset(SW_Downstream, !supertype3.to == "Unassigned" & weightRelative_path>0.001)
...
NODES[NODES$name == "ExR1",c(2,3)]=c(-137.5,0)
NODES[NODES$name == "ExR3",c(2,3)]=c(-87.5,0)
...
NODES[NODES$name == "ExR3",c(2,3)]=c(-87.5,0)
NODES[NODES$name == "hDeltaK",c(2,3)]=c(-40,0)
NODES[NODES$name == "PFGs",c(2,3)]=c(-87.5-20,10)
