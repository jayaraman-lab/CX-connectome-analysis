...
# Assign columns to Delta0s and plot crosses
```{r}


# First need to detect which neurons are delta12s


# Assign column names based on closest neuron
D0_Distribution_Columns = Assign_FB_Columns(D0_Distribution_Filt, FX_Distribution_Filt, D0_Dir_Mapping)
...
D0L_NamedBodies=subset(NamedBodies, startsWith(bodytype,"Delta0L"))
D0L_Syns=neuprint_get_synapses(D0L_NamedBodies$bodyid, roi = "FBl1")
