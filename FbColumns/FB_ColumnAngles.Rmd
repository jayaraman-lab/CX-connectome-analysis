...
# Reverse X position so that 0 to 1 correspond to right to left (to agree with schematic's front view on the brain)
Position_And_Tuning$X_Norm_Rev=(-1*Position_And_Tuning$X_Norm)+1
...
Px=ggplot() + 
  geom_point(data=Temp_Pos_And_Tune, aes(x=X_Norm_Rev, y=EPG_Angle, color=Colorz, ), size=3, shape=21)  +
