...
# Why are there so many points at 67.5 & 112.5 points? The average of these two numbr gives you 90!!! (plot histograms)
# Can't get a good estimate for PFR_b due to double bands
...
Position_And_Tuning$X_Norm=(Position_And_Tuning$X - Position_And_Tuning$Min_X)/Position_Norm$Total_X
