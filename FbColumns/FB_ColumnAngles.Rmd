...
# Why are there so many points at 67.5 & 112.5 points? The average of these two numbr gives you 90!!! 
...
P1=ggplot() +  
  ...
  geom_beeswarm(data=PhaseShiftData, aes(x=type.from, y=EPG_Angle_Diff, size=EPG_Angle_rho, color=type.to), shape=21) +
...
PhaseShiftData_Type=subset(PhaseShiftData_Type, NeuronNum>=5)
...
P1=ggplot() +  
  ...
  #geom_line(data=PhaseShift_Mean, aes(x=type.from, y=EPG_Angle_Diff_Mean, group=1), color="black") +
  xlab("Pre-synaptic PFN type") + ylab("Phase shift (deg)") + theme(axis.text.x = element_text(angle = 90)) +
  scale_color_manual(values=FBPal)
