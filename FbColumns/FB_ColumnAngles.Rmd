...
Ps
ggsave(paste(PlotDir, "PhaseShift_by_AngleNumer", ".png", sep=""),
       plot = Ps, device='png', scale = 1, width = 4, height = 3, units ="in", dpi = 500, limitsize = TRUE)
...
for (nnn in 1:length(PFNTypes)){
  ...
  ggsave(paste(PlotDir, "PhaseShift_by_AngleNumer_", PFNTypes[nnn], ".png", sep=""),
         plot = Ps, device='png', scale = 1, width = 5, height = 4, units ="in", dpi = 500, limitsize = TRUE)
...
Px=ggplot() + 
  ...
  theme(text = element_text(size=16), 
        ...
        axis.text.y = element_text(color="black"))
Px
ggsave(paste(PlotDir, "FX_MeanPhaseShift_Norm", ".png", sep=""),
       plot = Px, device='png', scale = 1, width = 8, height = 5, units ="in", dpi = 500, limitsize = TRUE)
