...
ggplot(R_R_plotdata, aes(x=roi_names, y=type, size=count)) + geom_point(aes(color=roi)) +
...
pdf(file=paste(PlotDir, "FIGURE_RingNeuron_","inputOutputRegions_perType.pdf",sep=""), width=14, height=8)
ggplot(R_R_plotdataSubset, aes(x=roi_names, y=type, size=count)) + geom_point(aes(color=roi)) + 
