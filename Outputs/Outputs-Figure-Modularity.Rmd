...
Finally we generate the plot (using an all white palette for the ROIs)
```{r}
rPal <- roisPalette(rois = selectRoiSet(roisPalette(),default_level = 0))
rPalNoPal[1:length(rPalNoPal)] <- "white"
