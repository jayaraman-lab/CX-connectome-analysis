...
```{r}
StrongMBON2nonCXwCXRTgtInpCombSortConnMatByOutputs <- connectivityMatrix(StrongMBON2nonCXwCXRTgtInpCombSort,unique(StrongMBON2nonCXwCXRTgtInpCombSort$roi),allToAll=FALSE,from="type.from",to="type.to",value="weightRelative",ref="outputs")
StrongMBON2nonCXwCXRTgtInpCombSortConnMatByOutputs_CosDist <- cos_dist(StrongMBON2nonCXwCXRTgtInpCombSortConnMatByOutputs)
StrongMBON2nonCXwCXRTgtInpCombSortConnMatByOutputs_CosDistPlot <- HHplot_dist(StrongMBON2nonCXwCXRTgtInpCombSortConnMatByOutputs_CosDist, order=TRUE)
print(StrongMBON2nonCXwCXRTgtInpCombSortConnMatByOutputs_CosDistPlot)
