...
# midTypes <- c("SMP354_R","SLP396_R");
# midTypes <- c("LAL039_R","LAL051_R");
filterIndirectConnections(midTypes,StrongMBON2nonCXwCXRTgtInpCombSort,StrongMBONnonCXTargetR2CXRtab,PlotDir)
```
