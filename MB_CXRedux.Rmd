...
# StrongMBON2CX_2ndTargetsToPostInFB_Type2TypeTab_hcByTo <- StrongMBON2CX_2ndTargetsToPostInFB_Type2TypeTab
# StrongMBON2CX_2ndTargetsToPostInFB_Type2TypeTab_hcByTo$type.to <- factor(StrongMBON2CX_2ndTargetsToPostInFB_Type2TypeTab_hcByTo$type.to, levels = hc$labels[hc$order], ordered=TRUE)
# StrongMBON2CX_2ndTargetsToPostInFB_Type2TypeTab_hcByTo <- arrange(StrongMBON2CX_2ndTargetsToPostInFB_Type2TypeTab_hcByTo,type.to)

# Plot and save the StrongMBON2CX_2ndTargetsToPostInFB_Type2TypeTab_hcByTo based on the connectionMeasure of "weightRelative"
# plotStrongMBON2CX2ndTargetsToPostInFB_Type2Type_hc <- plotConnectivityMatrix(StrongMBON2CX_2ndTargetsToPostInFB_Type2TypeTab_hcByTo,byGroup="type",connectionMeasure="weightRelative")
