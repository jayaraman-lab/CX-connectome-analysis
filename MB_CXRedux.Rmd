...
# Rearrange StrongMBON2nonCXwCXRTgtInpCombSort based on cluster.to
StrongMBON2nonCXwCXRTgtInpCombSort <- arrange(StrongMBON2nonCXwCXRTgtInpCombSort,cluster.to,cluster.from,type.to,type.from)
...
# Rearrange StrongMBONnonCXTargetR2CXRtab based on cluster.to of StrongMBON2nonCXwCXRTgtInpCombSort
StrongMBONnonCXTargetR2CXRtab <- arrange(StrongMBONnonCXTargetR2CXRtab,cluster.toFrom,cluster.to,cluster.from,type.from,type.to)
