...
StrongMBON2CXTargetsToPostInFB_Type2TypeTab <- StrongMBON2CXTargetsToPostInFB_Type2TypeTab  %>% filter(weightRelative > 0.02)
...
xyLookup = data.frame(type = types, x = c(xFrom,rep(1,times = numTypes-numFrom)), 
                      y = c(yFrom, seq(-3,3,length.out = numTypes-numFrom)))
