...
MBONTargetBag = neuronBag(as.vector(MBONCXTargetsL))
MBONTargetBagLat = lateralize_types(MBONTargetBag)

MBONnonCXTargetBag = neuronBag(as.vector(MBONnonCXTargetsL))
...
StrongMBON2CX_TargetsCnctTable <- getConnectionTable(StrongMBON2CXallTargetNeurons,synapseType="POST")
