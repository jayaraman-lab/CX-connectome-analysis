...
ggsave("FAFB_PB.pdf", plot = last_plot(), device='pdf', 
       path = "C:\\Users\\turnerevansd\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\Overview\\",
...
ggplot(FIBSEM_PB  %>% filter(ROIweight > synapseCutOff)) + 
  theme_classic() + theme(axis.text.x = element_text(angle = 90)) +
  scale_fill_gradient2(low="ivory", mid="peachpuff", high="black", limits=c(0,120)) +
  geom_tile(aes(nameid,partnerid,fill=ROIweight))+coord_fixed(ratio=1)

ggsave("FIBSEM_PB.pdf", plot = last_plot(), device='pdf', 
       path = "C:\\Users\\turnerevansd\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\Overview\\",
       scale = 1.5, width = 20, height = 15, units ="cm", dpi = 600, limitsize = TRUE)
```
...
ggsave("FAFB_EB.pdf", plot = last_plot(), device='pdf', 
       path = "C:\\Users\\turnerevansd\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\Overview\\",
       scale = 1.5, width = 20, height = 15, units ="cm", dpi = 600, limitsize = TRUE)
...
ggplot(FIBSEM_EB  %>% filter(ROIweight > synapseCutOff)) + 
  theme_classic() + theme(axis.text.x = element_text(angle = 90)) +
  scale_fill_gradient2(low="ivory", mid="peachpuff", high="black", limits=c(0,175)) +
  geom_tile(aes(nameid,partnerid,fill=ROIweight))+coord_fixed(ratio=1)

ggsave("FIBSEM_EB.pdf", plot = last_plot(), device='pdf', 
       path = "C:\\Users\\turnerevansd\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\Overview\\",
       scale = 1.5, width = 20, height = 15, units ="cm", dpi = 600, limitsize = TRUE)
```
