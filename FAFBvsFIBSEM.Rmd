...
FIBSEMNames <- FIBSEM_PB_Mat$nameid.from %>% as.character() %>% append(FIBSEM_PB_Mat$nameid.to %>% as.character()) %>% unique() %>% sort()
newFIBSEMNames <- c("Delta7-1R9R8La","Delta7-1R9R8Lb","Delta7-1R9R8Lc","Delta7-1R9R8Ld","Delta7-1R9R8Le",
                    "Delta7-2R7La","Delta7-2R7Lb","Delta7-2R7Lc","Delta7-2R7Ld","Delta7-2R7Le",
                    "Delta7-5R4La","Delta7-5R4Lb","Delta7-5R4Lc","Delta7-5R4Ld","Delta7-5R4Le",
                    "Delta7-6R3La","Delta7-6R3Lb","Delta7-6R3Lc","Delta7-6R3Ld","Delta7-6R3Le",
                    "Delta7-7R2La","Delta7-7R2Lb","Delta7-7R2Lc",
                    "EPG-5Ra","EPG-5Rb","EPG-5Rc","EPG-6Ra","EPG-6Rb","EPG-6Rc",
                    "EPG-5La","EPG-5Lb","EPG-5Lc","EPG-6La","EPG-6Lb","EPG-6Lc",
                    "PEG-5R", "PEG-6R","PEG-5L","PEG-6L",
                    "PEN1-5R", "PEN1-6Ra","PEN1-6Rb","PEN1-7R","PEN1-5L", "PEN1-6La","PEN1-6Lb","PEN1-7L",
...
PBNameOrder <- c("EPG-5Ra","EPG-5Rb","EPG-5Rc",
                 "EPG-5La","EPG-5Lb","EPG-5Lc",
                 "EPG-6Ra","EPG-6Rb","EPG-6Rc",
                 "EPG-6La","EPG-6Lb","EPG-6Lc",
                 "PEG-5R","PEG-5L","PEG-6R","PEG-6L",
                 "PEN1-5R","PEN1-5L",
                 "PEN1-6Ra","PEN1-6Rb","PEN1-6La","PEN1-6Lb",
                 "PEN1-7R","PEN1-7L",
                 "PEN2-5R","PEN2-5L",
                 "PEN2-6Ra","PEN2-6Rb","PEN2-6La","PEN2-6Lb",
                 "PEN2-7R", "PEN2-7L",
                 "Delta7-5R4La","Delta7-5R4Lb","Delta7-5R4Lc","Delta7-5R4Ld","Delta7-5R4Le",
                 "Delta7-6R3La","Delta7-6R3Lb","Delta7-6R3Lc","Delta7-6R3Ld","Delta7-6R3Le",
                 "Delta7-7R2La","Delta7-7R2Lb","Delta7-7R2Lc",
...
FIBSEM_PB$nameid.from <- factor(FIBSEM_PB$nameid.from, levels = PBNameOrder)
FIBSEM_PB$nameid.to <- factor(FIBSEM_PB$nameid.to, levels = PBNameOrder)
...
newFIBSEMNames <- c("Delta7-1R9R8L","Delta7-2R7L","Delta7-5R4La","Delta7-5R4Lb","Delta7-6R3La","Delta7-6R3Lb","Delta7-7R2L",
                    "EPG-5Ra","EPG-5Rb","EPG-5Rc","EPG-6Ra","EPG-6Rb","EPG-5La","EPG-5Lb","EPG-5Lc","EPG-6La","EPG-6Lb",
                    "PEG-5R", "PEG-6R","PEG-5L","PEG-6L",
                    "PEN1-5R", "PEN1-6Ra","PEN1-6Rb","PEN1-7R","PEN1-5L", "PEN1-6La","PEN1-6Lb","PEN1-7L",
                    "PEN2-5R", "PEN2-6Ra","PEN2-6Rb","PEN2-7R","PEN2-5L", "PEN2-6La","PEN2-6Lb","PEN2-7L")
...
nronsToAdd <-  c("EPG-6La","EPG-6Lb")
FIBSEM_PB_Cut <- FIBSEM_PB_Cut %>% select(nameid.from, nameid.to, ROIweight)
for (nPre in 1:length(nronsToAdd)){
  for (nPost in 1:length(nronsToAdd)){
    if (nrow(FIBSEM_PB_Cut %>%
             filter(as.character(nameid.from) == nronsToAdd[nPre] &
                    as.character(nameid.to) == nronsToAdd[nPost])) == 0)
      FIBSEM_PB_Cut <- FIBSEM_PB_Cut %>% rbind(data.frame(nameid.from = nronsToAdd[nPre], nameid.to = nronsToAdd[nPost], ROIweight = 0))
  }
}
FIBSEM_PB_Cut <- FIBSEM_PB_Cut %>% dcast(nameid.from~nameid.to)
FIBSEM_PB_Cut[is.na(FIBSEM_PB_Cut)] <- 0
FIBSEM_PB_Cut <- melt(FIBSEM_PB_Cut)
colnames(FIBSEM_PB_Cut) <- c("nameid.from","nameid.to","ROIweight")
FIBSEM_PB_Cut$nameid.from <- factor(FIBSEM_PB_Cut$nameid.from, levels = newFIBSEMNames %>% sort())
FIBSEM_PB_Cut$nameid.to <- factor(FIBSEM_PB_Cut$nameid.to, levels = newFIBSEMNames %>% sort())
...
newFIBSEMNames <- c("Delta7-1R9R8La","Delta7-1R9R8Lb","Delta7-1R9R8Lc","Delta7-1R9R8Ld","Delta7-1R9R8Le",
                    ...
                    "Delta7-6R3La","Delta7-6R3Lb","Delta7-6R3Lc","Delta7-6R3Ld","Delta7-6R3Le",
                    "Delta7-7R2La","Delta7-7R2Lb","Delta7-7R2Lc",
                    "EPG-5Ra","EPG-5Rb","EPG-5Rc","EPG-6Ra","EPG-6Rb","EPG-6Rc","EPG-5La","EPG-5Lb","EPG-5Lc","EPG-6La","EPG-6Lb","EPG-6Lc")
...
FIBSEMNames <- FIBSEM_PB$nameid.from %>% as.character() %>% append(FIBSEM_PB$nameid.to %>% as.character()) %>% unique() %>% sort()
newFIBSEMNames <- c("EPG-5Ra","EPG-5Rb","EPG-5Rc","EPG-6Ra","EPG-6Rb","EPG-6Rc","EPG-5La","EPG-5Lb","EPG-5Lc","EPG-6La","EPG-6Lb","EPG-6Lc",
                    "PEN1-5R", "PEN1-6Ra","PEN1-6Rb","PEN1-5L", "PEN1-6La","PEN1-6Lb")
nameLU_FIBSEM <- data.frame(oldName = FIBSEMNames, newName = newFIBSEMNames)
FIBSEM_PB$nameid.from <- sapply(FIBSEM_PB$nameid.from, function(x) nameLU_FIBSEM$newName[match(as.character(x), nameLU_FIBSEM$oldName)])
FIBSEM_PB$nameid.to <- sapply(FIBSEM_PB$nameid.to, function(x) nameLU_FIBSEM$newName[match(as.character(x), nameLU_FIBSEM$oldName)])
...
gFAFB <- ggplot(FAFB_EB_df  %>% filter(!grepl("R4m",nameid) & !grepl("R4m",partnerid))) + 
  theme_classic() + theme(axis.text.x = element_text(angle = 90)) +
...
newFIBSEMNames <- c("EPG-5Ra","EPG-5Rb","EPG-5Rc","EPG-6Ra","EPG-6Rb","EPG-5La","EPG-5Lb","EPG-5Lc","EPG-6La","EPG-6Lb",
                    "PEG-5R", "PEG-6R","PEG-5L","PEG-6L",
                    "PEN1-5R", "PEN1-6Ra","PEN1-6Rb","PEN1-7R","PEN1-5L", "PEN1-6La","PEN1-6Lb","PEN1-7L",
                    "PEN2-5R", "PEN2-6Ra","PEN2-6Rb","PEN2-7R","PEN2-5L", "PEN2-6La","PEN2-6Lb","PEN2-7L")
#,"R4m-a","R4m-b","R4m-c","R4m-d","R4m-e","R4m-f","R4m-g")
...
Compare the two matrices
```{r}
FAFB_EB_df <- FAFB_EB_df %>% filter(!grepl("R4m",nameid) & !grepl("R4m",partnerid))
...
gFAFB <- ggplot(FAFB_NO_df  %>% filter(weight > synapseCutOff)) + 
  theme_classic() + theme(axis.text.x = element_text(angle = 90)) +
  scale_fill_gradient2(low="white", mid="#ff694a", high="#6b000d", midpoint =60, limits=c(0,50)) +
  geom_tile(aes(nameid,partnerid,fill=weight))+coord_fixed(ratio=1)
