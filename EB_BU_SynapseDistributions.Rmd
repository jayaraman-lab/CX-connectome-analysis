...
# To Do:
# 1) Need to account for variable number of outputs
# 2) Improve getting outline of data and get it to work with ring neurons in EB
# 3) Look at synapse distributions in BU in Z
# 4) Look at synapse distributions in cross section of EB


# Make plots for BU 
Cmax=50 # Max for color bar
PlotSynapseDistributions(RingNeuron_BUsyns_BUax, BU_Outline, BU_Outline, "BUr", PlotDir)


# Make plots for EB
Cmax=100 # Max for color bar
PlotSynapseDistributions(RingNeuron_EBsyns_EBax, EB_Ring1, EB_Ring2, "EB", Cmax, PlotDir)
