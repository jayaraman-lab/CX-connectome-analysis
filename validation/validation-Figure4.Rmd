...
This notebook generates the plots related to the "validation" figures, which are figures 3 and 4
...
- We then reformats those tables so that we can compare the comparisons between the same type in different glomeruli. First for the inputs: 
