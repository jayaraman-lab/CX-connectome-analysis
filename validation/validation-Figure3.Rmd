...
## Plot the meshes
shade3d(exampleEPGOld,color=supertype2Palette()$pal["EPG"])
shade3d(exampleEPGNew,color="green")

## Plot the synapses
plot3d(epgInputSynapsesOld,add=T,col="orange",type="s",size=0.15)
plot3d(epgInputSynapsesNew,add=T,col="yellow",type="s",size=0.15)
...
plot3d(epgInputSynapsesNew,add=T,col="yellow",type="s",size=0.07)
