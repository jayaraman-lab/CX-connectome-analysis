...
```{r}
EPGToPFL23Plt <- plotConnectivityMatrix(EPGToPFL23,byGroup = "id_sort", connectionMeasure="ROIweight",cmax=100) + 
...
```{r}
PFL2ToDNPlt <- plotConnectivityMatrix(PFLs_to_DNs %>% filter((type.to != "MDN") & (type.from == "PFL2")),
                                      byGroup = "id_sort", connectionMeasure="ROIweight",cmax=100) + 
  coord_fixed(ratio=1) + xlab("postsynaptic neuron") + ylab("presynaptic neuron") + 
  theme_paper() + theme(axis.text.x = element_text(angle=90))
print(PFL2ToDNPlt)

PFL3ToDNPlt <- plotConnectivityMatrix(PFLs_to_DNs %>% filter((type.to != "MDN") & (type.from == "PFL3")),
                                      byGroup = "id_sort", connectionMeasure="ROIweight",cmax=100) + 
  coord_fixed(ratio=1) + xlab("postsynaptic neuron") + ylab("presynaptic neuron") + 
  theme_paper() + theme(axis.text.x = element_text(angle=90))
print(PFL3ToDNPlt)
...
Save the plots
```{r}
connMats <- EPGToPFL23Plt + PFL23ToDNPlt + plot_layout(widths = c(2,1),guides='collect')
ggsave("C:\\Users\\dantu\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\FirstDraftFigs\\outputs etc\\v5\\Individual Files\\DTE\\EPGToPFLToDNCMs.pdf",connMats,
       width=8, height=4, units = "in")
```
```{r}
PFL23ToDNPlt <- PFL2ToDNPlt + PFL3ToDNPlt + plot_layout(widths = c(1,2), guides = 'collect')
ggsave("C:\\Users\\dantu\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\FirstDraftFigs\\outputs etc\\v5\\Individual Files\\DTE\\PFLToDNCM.pdf",PFL23ToDNPlt,
       width=3.5, height=2.5, units = "in")
```
```{r}
ggsave("C:\\Users\\dantu\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\FirstDraftFigs\\outputs etc\\v5\\Individual Files\\DTE\\PFLBumpAct.pdf",PFLactAll,
       width=6, height=2.5, units = "in")
```
```{r}
sumPFL_plts_imp <- sumPFL2_plt_imp + sumPFL3_plt_imp
ggsave("C:\\Users\\dantu\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\FirstDraftFigs\\outputs etc\\v5\\Individual Files\\DTE\\EPGToPFLActImp.pdf",sumPFL_plts_imp,
       width=3.5, height=1.5, units = "in")
```
```{r}
DN_plts <- DN_From_PFL2_plt + DN_From_PFL3_plt + plot_layout(widths = c(1,2))
ggsave("C:\\Users\\dantu\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\FirstDraftFigs\\outputs etc\\v5\\Individual Files\\DTE\\EPGToPFLToDNAct.pdf",DN_plts,
