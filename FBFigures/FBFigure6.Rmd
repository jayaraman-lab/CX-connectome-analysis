...
```{r}
connectivityCluster(T2T_FBCol_filtered)
```
...
Data4Corr[is.na(Data4Corr)] <- 0.0
rownames(Data4Corr) <- Data4Corr$type.to
Data4Corr <- Data4Corr %>% select(tail(colnames(Data4Corr),ncol(Data4Corr)-1)) %>% as.matrix()
...
Combine, plot, and save
```{r}
pdf("C:\\Users\\turnerevansd\\Dropbox (HHMI)\\FIBSEM CX Paper Jan 2020\\Figures\\FirstDraftFigs\\FB\\FIGURE_6_ColNronNetwork\\FBColCor_Filtered.pdf")
