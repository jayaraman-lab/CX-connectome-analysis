...
```{r}
haneschFBSleep <- haneschPlot(FBSummary %>% filter(grepl("FB7B|FB7A|FB7K|FB6Z|FB6C_a|FB6E|FB6I|FB6C_b|FB6A|FB6G|FB6H",type) & !grepl("_L",type)),roiSelect=FBRois,flip = T,roiLabel = labelRoisFB,grouping="supertype1",interactive = TRUE,showCount = T,theme=theme_paper_grid()) + scale_size_area(max_size = 9)
haneschFBSleep_ttF <- haneschPlot(FBSummary_ttFiltered %>% filter(grepl("FB7B|FB7A|FB7K|FB6Z|FB6C_a|FB6E|FB6I|FB6C_b|FB6A|FB6G|FB6H",type) & !grepl("_L",type)),roiSelect=FBRois,flip = T,roiLabel = labelRoisFB,grouping="supertype1",interactive = TRUE,showCount = T,theme=theme_paper_grid())+ scale_size_area(max_size = 9)
haneschFBSleep
haneschFBSleep_ttF
```
