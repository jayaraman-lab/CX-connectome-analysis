...
```{r}
p4 <- plotConnectivityMatrix(MBON_CX_TypeToTypeConnections,byGroup = "type",connectionMeasure="outputContribution")
print(p4)
ggsave("MBON_CX_ConnectionsByType_outputContribution.eps", plot=p4, device="eps", path=PlotDir, scale=1, 
       width=11, height=8, units="in", dpi=300, limitsize=TRUE)
```
