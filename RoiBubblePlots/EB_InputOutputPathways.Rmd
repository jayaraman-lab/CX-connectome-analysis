...
EB_Type = EB_Type[ !(EB_Type %in% c("FB1C","FB3E","Delta6I","FB6P","FS2A","SAF","SIFamide" )) ]
...
# load(file = paste(SaveDir,"EB_Types.RData",sep=""))
...
ROISubset$FACET[ startsWith(ROISubset$type_name,"EP") | startsWith(ROISubset$type_name,"PE")|
                   startsWith(ROISubset$type_name,"PE") | startsWith(ROISubset$type_name,"EL")] <- "Columnar Neurons"
...
ggsave(paste(PlotDir, "FIGURE_ROI_EB_ALL.pdf",sep=""), plot = p0, device='pdf', scale = 1, 
       width = 16, height = 16, units ="in", dpi = 600, limitsize = TRUE)
