...
# load(file = paste(SaveDir,"PB_Types.RData",sep=""))
...
ggsave(paste(PlotDir, "FIGURE_ROI_PB_ALL.pdf",sep=""), plot = p0, device='pdf', scale = 1, 
       width = 16, height = 16, units ="in", dpi = 600, limitsize = TRUE)



# Plot all of the ROIs (and sub ROIs) that all PB neurons innervate
p0<-ggplot(ROISubset_Thresh, aes(x=roi_names, y=type_name, size=RelativeCount)) +  geom_point(color="black", stroke = 1.75)   + 
