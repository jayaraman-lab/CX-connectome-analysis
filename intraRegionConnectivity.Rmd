...
saveName = paste0("RN_in_",slctROI) #paste0("allBU")
...
useCustomPostSelection = TRUE#FALSE
useCustomPreSelection = TRUE#TRUE
...
if (useCuratedListPre) {
  ...
  if(useCustomPreSelection){
    preNeuron = c("R1.*","R2.*","R3.*","R4.*","R5.*","R6.*")
    preName = paste0("RN in ",slctROI)
  }else{
