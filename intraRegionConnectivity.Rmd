...
saveName = paste0("allIn_",slctROI) #RN_TB_ExR #RN_ExR_col_in_
...
useCustomPreSelection = FALSE#FALSE#
...
if (useCuratedListPost) {
  ...
  if(useCustomPostSelection){
    postNeuron = "ER4d"#c(paste0("ER",seq(6)))
