---
title: "Illustration of tools for analysing information flow between neurons within a region"
output:
  html_document:
    df_print: paged
---
...
```{r}
preNeuron = c("R1","R2","R3","R4","R5","R6","TuBu","PDM21a","ExR", "MC")
postNeuron = c("R1","R2","R3","R4","R5","R6","TuBu","PDM21a","ExR", "MC")
#c("MC","PDM21a")#c("TuBu")#c("ExR","R3","R2","R4","R5","R6","EPG")#c("ExR","R3","R2","R4","EPG")# c("R2","R3","R4","R5","R6","TuBu","PDM21a","ExR", "MC")

preName =  "R1-6, ExR, PDM21a and TuBus"
postName =  "R1-6, ExR, PDM21a and TuBus"
##"TuBus"#"MCs, PDM21a and TuBus"#"ExRs, R2-6 & EPG"#"R2-4 and TuBus"#"ExRs, R2-4 & EPG" # "R2-6, ExR, PDM21a and TuBus"

saveName = "_R1-6s_ExR_TuBu"
#"_MCsPDM21a_to_TuBus"#"_MCs_PDM21a_TuBus"#"_ExR_R2-6_EPG"#"_R2-4s_TuBU"#"_ExR_R2-4_EPG"
...
V(connectGraph)$size = 7 + as.numeric(graphData_selfFB$weight) #typeCounts$n/2 #
