...
```{r}
rot = c(0,0,180) #BU (45,180, 0) #EB: (0,0,180)
...
ggsave( paste("synapseDistributions_",saveName,'_side_simpletype.pdf', sep=''), plot = synprojSide, device='pdf', path = "../neuprintR_analysis_plots/",
    scale = 1.5, width = plotW, height = plotH, units ="cm", dpi = 600, limitsize = TRUE)
...
synprojSlice = ggplot() + 
  ...
  geom_hex(data=synPtsPlane, aes(x=z, y=syn_dist,fill=type, alpha=..density..), bins=50) +
