...
EPG_2_Delta7$nameid = paste(as.character(EPG_2_Delta7$name.from), as.character(EPG_2_Delta7$to), sep = "_")
EPG_2_Delta7$partnerid = paste(as.character(EPG_2_Delta7$name.to), as.character(EPG_2_Delta7$from), sep = "_")
...
Delta7_2_EPG$nameid = paste(as.character(Delta7_2_EPG$name.from), as.character(Delta7_2_EPG$to), sep = "_")
Delta7_2_EPG$partnerid = paste(as.character(Delta7_2_EPG$name.to), as.character(Delta7_2_EPG$from), sep = "_")
