...
plotConnectivityMatrix(Delta7_2_PEN1, synapseCutOff = 1, 0)
...
Delta7_2_PEN1_RO$longPartnerName <- factor(Delta7_2_PEN1_RO$longPartnerName,
        levels = glomSort(Delta7_2_PEN1_RO$longPartnerName))
